...
pub fn conformer_conv_module_forward(
    ...
    //    left as a causal conv would. Cera previously did all-left
    ...
    //    output: cera output[t=0, c=0..2] = [-0.197, 0.003, 0.417]
...
mod tests {
    ...
    fn from_gguf_real_lfm2a_audio_mmproj() {
        ...
        // Real-bundle config (verified via `cera-cli inspect`):
