...
fn q4_block_loop_0( m_0 : u32,  k_0 : u32,  r0_0 : u32,  ix_0 : u32,  il_0 : u32,  sumf_0 : ptr<function, array<f32, i32(8)>>)
{
    ...
    for(;;)
    {
        ...
        var _S4 : f32 = a1_0 * 0.00390625f;
        var _S5 : f32 = a3_0 * 0.00390625f;
        var _S6 : f32 = a5_0 * 0.00390625f;
        var _S7 : f32 = a7_0 * 0.00390625f;
        var _S8 : f32 = a8_0 * 0.0625f;
        var _S9 : f32 = a9_0 * 0.000244140625f;
        var _S10 : f32 = a10_0 * 0.0625f;
        var _S11 : f32 = a11_0 * 0.000244140625f;
        var _S12 : f32 = a12_0 * 0.0625f;
        var _S13 : f32 = a13_0 * 0.000244140625f;
        var _S14 : f32 = a14_0 * 0.0625f;
        ...
        for(;;)
        {
            ...
            var _S17 : u32 = r0_0 + r_0;
            if(_S17 >= m_0)
            {
                r_0 = r_0 + u32(1);
                continue;
            }
            var blk_byte_1 : u32 = _S17 * _S2 + ib_0 * u32(18);
            ...
            (*sumf_0)[r_0] = (*sumf_0)[r_0] + block_scale_0(blk_byte_1) * (_S16 * -8.0f + (a0_0 * f32((q0_0 & (u32(15)))) + a2_0 * f32((q1_0 & (u32(15)))) + a4_0 * f32((q2_0 & (u32(15)))) + a6_0 * f32((q3_0 & (u32(15))))) + (_S4 * f32((q0_0 & (u32(3840)))) + _S5 * f32((q1_0 & (u32(3840)))) + _S6 * f32((q2_0 & (u32(3840)))) + _S7 * f32((q3_0 & (u32(3840))))) + (_S8 * f32((q0_0 & (u32(240)))) + _S10 * f32((q1_0 & (u32(240)))) + _S12 * f32((q2_0 & (u32(240)))) + _S14 * f32((q3_0 & (u32(240))))) + (_S9 * f32((q0_0 & (u32(61440)))) + _S11 * f32((q1_0 & (u32(61440)))) + _S13 * f32((q2_0 & (u32(61440)))) + _S15 * f32((q3_0 & (u32(61440))))));
            r_0 = r_0 + u32(1);
        }
        var yb_off_1 : u32 = yb_off_0 + u32(1024);
        ib_0 = ib_0 + u32(32);
        yb_off_0 = yb_off_1;
    }
    return;
...
var<workgroup> partials_0 : array<f32, i32(512)>;

@compute
@workgroup_size(64, 1, 1)
fn gemv_q4_0_fast(@builtin(local_invocation_id) lid_0 : vec3<u32>, @builtin(workgroup_id) wid_1 : vec3<u32>)
{
    var m_1 : u32 = params_0[i32(0)].x;
    var r0_1 : u32 = get_wid_0(wid_1) * u32(8);
    ...
    for(;;)
    {
        ...
        partials_0[r_1 * u32(64) + tid_0] = sumf_1[r_1];
        r_1 = r_1 + u32(1);
    }
    workgroupBarrier();
    ...
    for(;;)
    {
        ...
        if(tid_0 < stride_0)
        {
            ...
            for(;;)
            {
                ...
                var idx_0 : u32 = r_1 * u32(64) + tid_0;
    ...
    if(tid_0 == u32(0))
    {
        ...
        for(;;)
        {
            ...
            var _S18 : u32 = r0_1 + r_1;
            if(_S18 < m_1)
            {
                y_0[_S18] = partials_0[r_1 * u32(64)];
            }
            r_1 = r_1 + u32(1);
        }
    }
