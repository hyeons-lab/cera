...
@binding(1) @group(0) var<storage, read> weight_buf_0 : array<f32>;
...
fn per_head_rmsnorm(@builtin(local_invocation_id) lid_0 : vec3<u32>, @builtin(workgroup_id) wid_0 : vec3<u32>)
{
    var tid_1 : u32 = lid_0.x;
    var head_dim_0 : u32 = par_buf_0[i32(0)].x;
    ...
    for(;;)
    {
        ...
        var partial_1 : f32 = partial_0 + x_buf_0[_S2 + i_0] * x_buf_0[_S2 + i_0];
        i_0 = i_0 + u32(256);
        partial_0 = partial_1;
    }
    ...
    for(;;)
    {
        ...
        var _S4 : u32 = _S2 + i_0;
        x_buf_0[_S4] = x_buf_0[_S4] * _S3 * weight_buf_0[i_0];
        i_0 = i_0 + u32(256);
    }
    return;
}
