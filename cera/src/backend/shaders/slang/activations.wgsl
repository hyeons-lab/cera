...
fn silu_inplace(@builtin(global_invocation_id) gid_1 : vec3<u32>)
{
    ...
    x_buf_0[i_1] = x_buf_0[i_1] / (1.0f + exp(- x_buf_0[i_1]));
    return;
}
...
fn gelu_erf_inplace(@builtin(global_invocation_id) gid_2 : vec3<u32>)
{
    ...
    x_buf_0[i_2] = 0.5f * v_0 * (1.0f + sign_0 * (1.0f - ((((1.06140542030334473f * t_0 - 1.45315194129943848f) * t_0 + 1.42141366004943848f) * t_0 - 0.28449669480323792f) * t_0 + 0.25482958555221558f) * t_0 * exp(- a_0 * a_0)));
    return;
}
