...
//! `cera::backend::cpu::conv2d` kernel. Shapes match the real
...
//!
//! ```bash
//! cargo test -p cera --release --test bench_conv2d -- --ignored --nocapture
//! ```
//!
...
#[test]
#[ignore = "perf bench; run with: cargo test -p cera --release --test bench_conv2d -- --ignored --nocapture"]
