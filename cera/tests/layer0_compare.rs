...
fn depthformer_layer0_standalone() {
    ...
    // ── Load known input ────────────────────────────────────────────────
    let input_path = "/tmp/cera_df_input.bin";
    ...
    dump_f32_bin("/tmp/cera_layer0_after_rmsnorm.bin", &cur);
    ...
    dump_f32_bin("/tmp/cera_layer0_after_qkv.bin", &qkv);
    ...
    dump_f32_bin("/tmp/cera_layer0_after_attn.bin", &attn_out);
    ...
    dump_f32_bin("/tmp/cera_layer0_after_ffn.bin", &cur);

    // ── Dump final layer 0 output ───────────────────────────────────────
    dump_f32_bin("/tmp/cera_layer0_standalone.bin", &cur);
    eprintln!("[layer0] all outputs dumped to /tmp/cera_layer0_*.bin");
}
