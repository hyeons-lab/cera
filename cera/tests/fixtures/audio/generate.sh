...
# piped through `afconvert` to the canonical cera audio-input format:
...
#   ./cera/tests/fixtures/audio/generate.sh
#
# Why an external TTS, not cera's own:
# - Independent oracle. If cera's TTS regresses, both directions of
#   any "cera → cera" self-test would drift together and the test
