...
- **Native Silero VAD v5 engine and bindings**: Added `SileroVadConfig`, `VadSampleRate`, `VadIterator`, and `VadEngine` for real-time speech activity detection, streaming audio chunk processing, and speech segment timestamping.
