...
// generated UniFFI Swift bindings end-to-end (against `libcera_ffi.dylib`
...
// `cera-parity/src/lib.rs` AND `Settings` in the Kotlin runner at
// `cera-parity/legs/kotlin/.../Main.kt` — drift between the three would
...
// Mirror of `cera_parity::settings` (Rust) and `Settings` (Kotlin).
...
func runOnce(_ args: RunArgsOwned) throws -> [UInt32] {
    ...
    // `ubatchSize: 512` mirrors `cera::SessionConfig::default()` —
